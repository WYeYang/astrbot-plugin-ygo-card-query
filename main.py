    ...
    async def query_card(self, event: AstrMessageEvent, sql: str = ""):
        ...
        Args:
            sql(string): SQL查询语句。格式：SELECT * FROM datas d JOIN texts t ON d.id=t.id WHERE ...
                ...
                - d.level: 等级/阶级/链接数
                - d.atk/d.def: 攻击力/防御力
                提示：查单张卡用 ORDER BY RANDOM() LIMIT 1；查多张用 ORDER BY RANDOM() LIMIT 3；搜效果用 t.desc LIKE '%关键词%'；查询时请使用简体中文关键词；此工具只需调用一次即可获取完整信息；如果用户想找"老婆"或妹卡（应该是怪兽卡），建议搜索：黑魔导女孩、青眼少女、闪刀姬、半龙女仆、龙女仆、虫惑魔、直播双子、邪恶双子、黄金卿、灰流丽、屋敷童子、幽鬼兔、浮幽樱、儚无水木、水晶机巧、魔女术、咒眼、海晶少女、淘气仙星、抒情歌鸲、铁兽战线、教导、圣骑士、七音服、魔偶甜点、芳香、鹰身女郎、亚马逊射手、电子化天使、命运女郎、蔷薇龙、幻奏、幻蝶刺客、灵使、凭依装着、守墓的巫女、混沌巫师、混沌女武神、混沌魔术师、黑混沌之魔术师、黑魔术少女、黑魔导女孩、黑魔导、黑魔术师、黑魔法神官、黑魔导执行官、黑魔导骑士、黑魔导战士等等；恶搞老婆：强欲之壶（壶妈）、贪欲之壶、金满之壶、强欲而金满之壶、强欲而贪欲之壶、强欲而谦虚之壶、无之炼狱、永火炮、蒲公英狮、三眼怪、弹射龟、处刑人、魔导科学家、八汰乌、混沌帝龙、电子壶、纤维壶、魔导书的神判、征龙、魔钟洞、虚无空间、技能抽取、大宇宙、王宫的敕命、神之宣告、神之警告、神之通告、神之威光、神之摄理、神之忠告、神之忠告、神之忠告（太多重复了，省略）等等
